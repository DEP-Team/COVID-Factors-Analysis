...
CREATE TABLE IF NOT EXISTS `county_csa` (
	`county_id` VARCHAR(5) NOT NULL,
	`csa_id` INT NOT NULL,
    `centrality` VARCHAR(10) NOT NULL,
    PRIMARY KEY (`county_id`, `csa_id`),
    INDEX `county_csa_county_pk_idx` (`county_id`, `csa_id`),
    INDEX `county_csa_csa_id_idx` (`csa_id`),
	CONSTRAINT `county_csa_county_id_fk`
		FOREIGN KEY (`county_id`)
		REFERENCES `county` (`county_id`),
	CONSTRAINT `county_csa_csa_id_fk`
		FOREIGN KEY (`csa_id`)
