...
CREATE TABLE IF NOT EXISTS `us_survey_response` (
  ...
  INDEX `dim_us_survey_response_us_survey_response_key_idx` (`us_survey_response_key` ASC) VISIBLE,
  INDEX `dim_us_survey_response_survey_response_id_idx` (`survey_response_id` ASC) VISIBLE,
  INDEX `dim_us_survey_response_survey_key_idx` (`survey_key`),
  INDEX `dim_us_survey_response_response_key_idx` (`response_key` ASC) VISIBLE,
  INDEX `dim_us_survey_response_characteristic_key_idx` (`characteristic_key` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `state_survey_response` (
  ...
  INDEX `dim_state_survey_response_state_survey_response_key_idx` (`state_survey_response_key` ASC) VISIBLE,
  INDEX `dim_state_survey_response_survey_response_id_idx` (`survey_response_id` ASC) VISIBLE,
  INDEX `dim_state_survey_response_state_key_idx` (`state_key`),
  INDEX `dim_state_survey_response_survey_key_idx` (`survey_key`),
  INDEX `dim_state_survey_response_response_key_idx` (`response_key` ASC) VISIBLE,
  INDEX `dim_state_survey_response_characteristic_key_idx` (`characteristic_key` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `msa_survey_response` (
  ...
  INDEX `dim_msa_survey_response_msa_survey_response_key_idx` (`msa_survey_response_key` ASC) VISIBLE,
  INDEX `dim_msa_survey_response_survey_response_id_idx` (`survey_response_id` ASC) VISIBLE,
  INDEX `dim_msa_survey_response_msa_key_idx` (`msa_key`),
  INDEX `dim_msa_survey_response_survey_key_idx` (`survey_key`),
  INDEX `dim_msa_survey_response_response_key_idx` (`response_key` ASC) VISIBLE,
  INDEX `dim_msa_survey_response_characteristic_key_idx` (`characteristic_key` ASC) VISIBLE,
